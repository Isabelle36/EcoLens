...
import EcoFriendlyCards from "../Home b4 Login/EcoFriendlyCards";
import CardContainer from "../Home b4 Login/WeCanHelpCard";
import Footer from "../Home b4 Login/footer";
...
export const HomeAfterLogin = () => {
  return (
    <div className="w-screen h-screen">
      ...
      <h1 className="text-8xl text-red-600 whatsec2 ">
        How we can help you ??
      </h1>
